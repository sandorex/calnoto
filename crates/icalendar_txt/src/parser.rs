...
use nom::{IResult, Parser, branch::alt, bytes::complete::{tag, take_till1}, character::complete::{char, digit1, line_ending, multispace0, one_of, space0}, combinator::{consumed, fail, map_res, opt, success, value, verify}, error::FromExternalError, multi::separated_list0, sequence::{delimited, pair, preceded, terminated}};
...
// #[derive(Debug)]
// pub enum MyError<'a, I> {
//     PeriodWithoutValue,
//     Nom(I, ErrorKind),
//     Ext(I, ErrorKind, Box<dyn std::error::Error>),
// }
//
// impl<'a, I, E: std::error::Error + Clone> FromExternalError<I, E> for MyError<'a, I> {
//     fn from_external_error(input: I, kind: ErrorKind, e: E) -> Self {
//         Self::Ext(input, kind, Box::new(e.clone()))
//     }
// }
//
// // impl<'a> ParseError<&'a str> for MyError<'a> {
...
pub fn parse_period(input: &str) -> IResult<&str, TimeDelta> {
